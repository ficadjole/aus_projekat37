...
namespace Modbus.ModbusFunctions
{
    ...
    public class ReadHoldingRegistersFunction : ModbusFunction
    {
        ...
        {
            ModbusReadCommandParameters paramCom = this.CommandParameters as ModbusReadCommandParameters;
            Dictionary<Tuple<PointType, ushort>, ushort> podaci = new Dictionary<Tuple<PointType, ushort>, ushort>();
            ...
            for (int i = 0; i < response[8] / 2; i++)
            {
                ...
                podaci.Add(new Tuple<PointType, ushort>(PointType.ANALOG_OUTPUT, address), value1);
                address++;
            }
            return podaci;
        }
