...
namespace dCom.Configuration
{
    internal class ConfigItem : IConfigItem
	{
		...
		private double egu_max;//max vrednost
		private double egu_min;//min vrednost
        private ushort abnormalValue;//ovo je samo za digitalne vrednosti
		private double highLimit; //ono preko cega ne treba ici
		private double lowLimit;// ono ispod cega ne treba ici
